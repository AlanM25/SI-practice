...
end_point =(475,225)
# draw the rectangle
cv2.rectangle(imageLine, start_point, end_point, (200, 0, 255), thickness= 3, lineType=cv2.LINE_8) 
...
# draw the ellipse
#Horizontal
cv2.ellipse(imageLine, ellipse_center, axis1, 0, 0, 360, (255, 0, 0), thickness=3)
#Vertical
cv2.ellipse(imageLine, ellipse_center, axis2, 90, 0, 360, (0, 0, 255), thickness=3)
